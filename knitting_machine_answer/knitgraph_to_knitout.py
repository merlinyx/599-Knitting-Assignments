...
from knitting_machine_answer.Machine_State import Machine_State, Needle, Pass_Direction
from knitting_machine_answer.machine_operations import outhook
from knitting_machine_answer.operation_sets import Carriage_Pass, Instruction_Type
